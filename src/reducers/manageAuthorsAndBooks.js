...
function authorsReducer(state = [], action) {
  ...
  switch (action.type) {
    ...
    case "ADD_BOOK":
      // WHERE do action.book and action.author get set?!
      // Answer: in actions/index.js (remember ES6 object syntax)
...
//       return {
//         ...state,
//         authors: [...state.authors], // This is in the README, but is it even needed? Update: Yes it is, in order to have immutable state!
