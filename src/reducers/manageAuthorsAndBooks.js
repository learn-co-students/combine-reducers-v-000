...
// We're using a useful package, uuid, to handle unique ID generation. With this refactor, since we are creating an author ID from within the 
// reducer instead of in AuthorInput.js, we need to import it here as well.
